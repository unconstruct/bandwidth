...
function load_udt_styles() {
	...
	//SoundManager2 CSS
}	wp_enqueue_style('page_player', get_template_directory_uri() . '/css/page-player.css', false, false, 'all');
	wp_enqueue_style('flashblock', get_template_directory_uri() . '/css/flashblock.css', false, false, 'all');
...
function load_udt_scripts() {
	...
	//SoundManager2 Scripts
	wp_enqueue_script('soundmanager2', get_template_directory_uri() . '/js/soundmanager2-jsmin.js', array('jquery','jquery-ui'), false, true);
	wp_enqueue_script('page_player', get_template_directory_uri() . '/js/page-player.js', array('jquery','jquery-ui'), false, true);
...
function sc_audio( $atts ) {
	extract( shortcode_atts( array(
		'type'=>array('soundcloud','streamguys'),
		'title' => '',
		'url' => '',
		'width' => '100%',
		'height' => '166px',
	...
	}else if($type=='streamguys'){
		$output='<ul class="playlist"><li><a href="http://downloads.wamu.org/'.$url.'">'.$title.'</a></li></ul>';
